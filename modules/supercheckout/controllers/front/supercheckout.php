						...
						if (is_callable(array($module_instance, 'hookPayment')) || is_callable(array($module_instance, 'hookDisplayPayment')))
						{
							...
							else
							{
                                ...
                                if ($module['name'] == 'braintreejs')
                                {
                                    ...
                                    $this->context->controller->addCSS(_PS_MODULE_DIR_.'braintreejs/views/css/braintree-prestashop.css', 'all');
                                    $this->context->controller->addJS('https://js.braintreegateway.com/js/braintree-2.26.0.min.js');
                                }
...
//				$_POST['newsletter'] = (isset($posted_data['customer_personal']['newsletter'])) ? 1 : 0;
                ...
                if ($this->context->customer->firstname == '-' || $this->context->customer->lastname == '-') {
                    ...
                    $customer->firstname = $posted_data['shipping_address']['firstname'];
                    $customer->lastname = $posted_data['shipping_address']['lastname'];
                    $this->context->customer->firstname = $customer->firstname;
                    $this->context->customer->lastname = $customer->lastname;
                    $customer->update();
