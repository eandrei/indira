...
// Build back the fields list for FANCourier, gift infos are send using the JS
$inputs = array();
...
if (Tools::isSubmit('first_call'))
	$onload_script = 'document.getElementById(\'FAN_Form\').submit();';
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
	...
	<body onload="<?php echo $onload_script; ?>">
		<form id="FAN_Form" name="form" action="<?php echo Configuration::get('FANCOURIER_URL'); ?>" method="POST">
			<?php
