...
<div class="panel">
<h3><i class="icon-hand-right"></i> {l s='Sizechart Group' mod='ilmsizechart'}
    ...
    <tr><td width="10%">{$group.id_group|escape:'htmlall':'UTF-8'}</td>
    <td width="70%">{$group.title|escape:'htmlall':'UTF-8'}</td>
    <td width="70%">{$group.active|escape:'intval'}</td>
    <td width="10%">
    <div class="btn-group-action">
    <div class="btn-group pull-right">
    	<a title="Edit" href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=ilmsizechart&addGroupChart=1&id_groupedit={$group.id_group|escape:'htmlall':'UTF-8'}" class="btn btn-default"><i class="icon-edit"></i> Edit</a>
    	<button data-toggle="dropdown" class="btn btn-default dropdown-toggle"><i class="icon-caret-down"></i>&nbsp;</button>
    	<ul class="dropdown-menu">
    		<li><a title="Delete" href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=ilmsizechart&id_groupdelete={$group.id_group|escape:'htmlall':'UTF-8'}"><i class="icon-trash"></i> Delete</a>
   		 </li>
    	</ul>
    </div>
    </div>
