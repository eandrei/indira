...
class EmagMarketplaceCharacteristic extends ObjectModel
{
 	/** @var string Name */
	public $name;
	public $position;
	...
	public static $definition = array(
		'table' => 'emagmp_characteristic_definitions',
		'primary' => 'emag_characteristic_id',
		'fields' => array(
			'emag_category_id' => array('type' => self::TYPE_INT),
			'emag_characteristic_name' => array('type' => self::TYPE_STRING, 'size' => 255),
			'id_feature' => array('type' => self::TYPE_INT),
			'id_attribute_group' => array('type' => self::TYPE_INT)
		)
	);
	...
	public function updateEmagFeatureID($emag_characteristic_id, $emag_category_id, $id_feature)
	{
		return Db::getInstance()->execute('
			INSERT INTO `'.pSQL(_DB_PREFIX_.'emagmp_features').'`
			SET
			emag_characteristic_id = '.(int)$emag_characteristic_id.',
			emag_category_id = '.(int)$emag_category_id.',
	...
	public function updateEmagAttributeGroupID($emag_characteristic_id, $emag_category_id, $id_attribute_group)
	{
		return Db::getInstance()->execute('
			INSERT INTO `'.pSQL(_DB_PREFIX_.'emagmp_attribute_groups').'`
			SET
			emag_characteristic_id = '.(int)$emag_characteristic_id.',
			emag_category_id = '.(int)$emag_category_id.',
	...
	*/
	public static function addFeatureImport($name, $position = false)
	{
		...
		foreach ($languages as $language)
			$feature->name[$language['id_lang']] = (string)$name;
		if ($position)
