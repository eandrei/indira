...
function displayCartRuleTab(tab) {
	$j('.cart_rule_tab').hide();
	$j('.tab-page').removeClass('selected');
	$j('#awocoupon_block_' + tab).show();
	$j('#awocoupon_block_link_' + tab).addClass('selected');
}
...
<form method="post" action="{$smarty.server.REQUEST_URI}" name="adminForm" id="cart_rule_form" onsubmit="return submitbutton();">
	...
	<div id="awocoupon_block_email" class="cart_rule_tab">
		...
		<tr valign="top">
			<td>
				...
				{foreach from=$languages item=language}
					<div class="lang_{$language.id_lang|intval}" style="display:{if $language.id_lang == $id_lang_default}block{else}none{/if};float:left">
						<textarea class="autoload_rte" cols="100" rows="20" id="email_html_{$language.id_lang|intval}" name="email_html_{$language.id_lang|intval}">{if isset($row->languages[$language.id_lang|intval]->email_body)}{$row->languages[$language.id_lang|intval]->email_body}{/if}</textarea>
					</div>
				{/foreach}
				</div>
			</td>
	...
	<div id="awocoupon_block_pdf" class="cart_rule_tab">
		...
		<tr valign="top">
			...
			<td>
				...
				{foreach from=$languages item=language}
					<div class="lang_{$language.id_lang|intval}" style="display:{if $language.id_lang == $id_lang_default}block{else}none{/if};float:left">
						<textarea class="autoload_rte" cols="100" rows="10" id="pdf_header_{$language.id_lang|intval}" name="pdf_header_{$language.id_lang|intval}">{if isset($row->languages[$language.id_lang|intval]->pdf_header)}{$row->languages[$language.id_lang|intval]->pdf_header}{/if}</textarea>
					</div>
				{/foreach}
				</div>
			</td>
		...
		<tr valign="top">
			...
			<td>
				...
				{foreach from=$languages item=language}
					<div class="lang_{$language.id_lang|intval}" style="display:{if $language.id_lang == $id_lang_default}block{else}none{/if};float:left">
						<textarea class="autoload_rte" cols="100" rows="20" id="pdf_body_{$language.id_lang|intval}" name="pdf_body_{$language.id_lang|intval}">{if isset($row->languages[$language.id_lang|intval]->pdf_body)}{$row->languages[$language.id_lang|intval]->pdf_body}{/if}</textarea>
					</div>
				{/foreach}
				</div>
			</td>
		...
		<tr valign="top">
			...
			<td>
				...
				{foreach from=$languages item=language}
					<div class="lang_{$language.id_lang|intval}" style="display:{if $language.id_lang == $id_lang_default}block{else}none{/if};float:left">
						<textarea class="autoload_rte" cols="100" rows="10" id="pdf_footer_{$language.id_lang|intval}" name="pdf_footer_{$language.id_lang|intval}">{if isset($row->languages[$language.id_lang|intval]->pdf_footer)}{$row->languages[$language.id_lang|intval]->pdf_footer}{/if}</textarea>
					</div>
				{/foreach}
				</div>
			</td>
