...
<br />
<form action="{$ajax_url}" method="post" id="adminForm" name="adminForm" target="_blank">
	...
	<br /><div class="margin-form"><input type="submit" value="   {l s='Run Report' mod='awocoupon'}   " name="submit" class="button"></div>
