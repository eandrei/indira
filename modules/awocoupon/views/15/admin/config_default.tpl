...
jQuery(document).ready(function() {
	...
	tinySetup({
		...
		setup : function(ed) {
			...
			{
				if (typeof ProductMultishop != 'undefined') {
...
form.form_tab { background-color:#ebedf4; border:1px solid #ccced7; min-height:404px; padding: 5px 10px 10px; margin-left:140px;}
...
<h2>{l s='Configuration' mod='awocoupon'}</h2>
