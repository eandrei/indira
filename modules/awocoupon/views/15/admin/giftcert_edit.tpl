...
<h2>{if $row->id>0}{l s='Edit' mod='awocoupon'}{else}{l s='New' mod='awocoupon'}{/if} {l s='Gift Certificate' mod='awocoupon'}</h2>
...
<div class="width-100">
	<fieldset class="adminform"><legend>{l s='General' mod='awocoupon'}</legend>
		<table class="admintable">
			<tr>
				<td class="key" nowrap><label>{l s='Product' mod='awocoupon'}</label></td>
				<td>{if $row->id > 0}
			...
			<tr>
				<td class="key" nowrap><label>{l s='Template' mod='awocoupon'}</label></td>
			...
			<tr>
				<td class="key" nowrap><label>{l s='Image' mod='awocoupon'}</label></td>
			...
			<tr>
				<td class="key" nowrap><label>{l s='Expiration' mod='awocoupon'}</label></td>
	...
	<fieldset class="adminform"><legend>{l s='Vendor' mod='awocoupon'}</legend>
		<table class="admintable">
			<tr>
				<td class="key" nowrap><label>{l s='Name' mod='awocoupon'}</label></td>
				<td><input class="inputbox" type="text" name="vendor_name" size="30" maxlength="255" value="{$row->vendor_name}" /></td>
			</tr>
			<tr>
				<td class="key" nowrap><label>{l s='Email' mod='awocoupon'}</label></td>
