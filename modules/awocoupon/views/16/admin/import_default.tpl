...
<div class="panel awocoupon">
	<h3><i class="icon-tag"></i> {l s='Import' mod='awocoupon'}</h3>


	<form id="{$table}_form" name="adminForm" method="post" action="{$smarty.server.REQUEST_URI}"  enctype="multipart/form-data">
		<div id="div_form_content" class="width-100">
			<fieldset class="adminform"><legend class="control-label">{l s='File' mod='awocoupon'}</legend>
	...
	<fieldset class="adminform" style="width:97%;position: relative;height:250px;"><legend>{l s='CSV Spreadsheet Format' mod='awocoupon'}</legend>
		<div id="div_sample" style="width:97%;border:1px solid #555;overflow-x:auto;background-color:#fff;position: absolute;">
