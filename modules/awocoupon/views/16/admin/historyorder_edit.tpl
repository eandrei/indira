...
<div class="panel awocoupon">
	<h3><i class="icon-tag"></i> {if $row->order_id>0}{l s='Edit' mod='awocoupon'}{else}{l s='New' mod='awocoupon'}{/if} {l s='Order Voucher' mod='awocoupon'}</h3>
	...
	<table class="admintable">
		<tr>
			<td class="key" nowrap><label class="control-label">{l s='Coupon Template' mod='awocoupon'}</label></td>
