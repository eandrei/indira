...
<div class="panel awocoupon">
	<h3><i class="icon-tag"></i> {if $row->id>0}{l s='Edit' mod='awocoupon'}{else}{l s='New' mod='awocoupon'}{/if} {l s='Coupon Usage' mod='awocoupon'}</h3>
	...
	<table class="admintable">
		...
		<tr>
			<td class="key" nowrap><label class="control-label">{l s='User Email' mod='awocoupon'}</label></td>
			<td><input class="inputbox" type="text" name="user_email" size="30" maxlength="255" value="{$row->user_email}" /></td>
		</tr>
		<tr>
			<td class="key" nowrap><label class="control-label">{l s='Product Discount' mod='awocoupon'}</label></td>
			<td><input class="inputbox" type="text" name="coupon_discount" size="30" maxlength="255" value="{$row->coupon_discount}" /></td>
		</tr>
		<tr>
			<td class="key" nowrap><label class="control-label">{l s='Shipping Discount' mod='awocoupon'}</label></td>
			<td><input class="inputbox" type="text" name="shipping_discount" size="30" maxlength="255" value="{$row->shipping_discount}" /></td>
		</tr>
		<tr>
			<td class="key" nowrap><label class="control-label">{l s='Order ID' mod='awocoupon'}</label></td>
