...
//$objPmReqCard->invoice->amount = $params['cart']->getOrderTotal(true, 3);
      ...
      //not supported by this shopping cart $deliveryAddress->fiscalNumber	= $_POST['shipping_fiscal_number'];
      //not supported by this shopping cart $deliveryAddress->identityNumber	= $_POST['shipping_identity_number'];
