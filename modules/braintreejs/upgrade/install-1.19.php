...
function upgrade_module_1_19($object, $install = false)
{
	...
	if ((!$bt_version) || (empty($bt_version)) || ($bt_version < $object->version))
		Configuration::updateValue('BRAINTREE_VERSION', '1.19');

	//default paypal future payments to disabled
	Configuration::updateValue('BRAINTREE_PAYPAL_FUTURE', 0);

	//default transaction log to disabled
	Configuration::updateValue('BRAINTREE_LOG_TRANSACTIONS', 0);
