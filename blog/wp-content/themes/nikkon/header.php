...
<?php echo ( get_theme_mod( 'nikkon-site-layout' ) == 'nikkon-site-boxed' ) ? '<div class="site-boxed">' : ''; ?>
	...
	<?php if ( is_page() && get_theme_mod( 'nikkon-page-fimage-layout' ) == 'nikkon-page-fimage-layout-banner' ) : ?>
		
		<?php get_template_part( '/templates/page-banner' ); ?>
		
	<?php elseif ( is_single() && get_theme_mod( 'nikkon-single-page-fimage-layout' ) == 'nikkon-single-page-fimage-layout-banner' ) : ?>
