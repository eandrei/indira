...
?>
	...
	<?php if ( get_theme_mod( 'nikkon-footer-layout', false ) == 'nikkon-footer-layout-custom' ) : ?>
		
		<?php get_template_part( '/templates/footers/footer-custom' ); ?>
		
	<?php elseif ( get_theme_mod( 'nikkon-footer-layout', false ) == 'nikkon-footer-layout-social' ) : ?>
