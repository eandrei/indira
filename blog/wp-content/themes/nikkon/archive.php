...
get_header(); ?>
	...
	<div id="primary" class="content-area <?php echo ( get_theme_mod( 'nikkon-blog-cat-full-width', false ) ) ? sanitize_html_class( 'content-area-full' ) : ''; ?>">
		<main id="main" class="site-main" role="main">
			...
			<?php if ( have_posts() ) : ?>
				...
				echo ( get_theme_mod( 'nikkon-blog-layout' ) == 'blog-blocks-layout' && get_theme_mod( 'nikkon-blog-cats-blocks' ) == 1 ) ? '<div class="blog-blocks-wrap blog-blocks-wrap-remove ' . sanitize_html_class( $blog_columns ) . ' ' . sanitize_html_class( $blog_style ) . '">' : '';
	...
	<?php if ( get_theme_mod( 'nikkon-blog-cat-full-width', false ) ) : ?>
        <!-- No Sidebar -->
    <?php else : ?>
        <?php get_sidebar(); ?>
    <?php endif; ?>
