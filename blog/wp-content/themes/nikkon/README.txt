...
* Remove social links if none are set
* Fix search layout bug
* Updated the language .pot file

#### 10.0.5
* Added Top Bar menu drop downs
* Added setting to place WooCommerce cart in header top bar
* Updated the language .pot file

#### 10.0.4
* Customizer javascript fix
* Added help for setting up Default Slider
* Add/Fix Layout Colors setting
* Styling tweaks/fixes
* Added setting to remove page titles
* Post and Page featured images and layout settings
* Fixed search on mobile
* Added settings to customize site title and sizes
* Added over 12 new social links
* Updated the language .pot file
