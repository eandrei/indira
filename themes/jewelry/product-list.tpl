				...
				<div class="right-block">
					...
					<div class="button-container">
						...
						<a itemprop="url" class="button lnk_view btn btn-default" href="{$product.link|escape:'html':'UTF-8'}" title="{l s='View'}">
							<span>{if (isset($product.customization_required) && $product.customization_required)}{l s='Customize'}{else}{l s='i'}{/if}</span>
						</a>
					</div>
					...
					{if $page_name != 'index'}
	 				<div class="functional-buttons">
						...
						{if isset($comparator_max_item) && $comparator_max_item}
							<div class="compare">
								<a class="add_to_compare" href="{$product.link|escape:'html':'UTF-8'}" data-id-product="{$product.id_product}">{l s=''}</a>
							</div>
						{/if}
					</div>
				{/if}
