		...
		<div class="pb-center-column col-xs-12 col-sm-7">
            ...
            <p>
                ...
                {if (in_array($date, [1,2,3,4]) && $hour < '16:00')}
                    ...
                    {$hours = ($time2 - $time1)/3600} {$minutes = intval(60 * ($hours - intval($hours)))}
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
		...
		<ul class="nav nav-tabs">
		 <li class="active"><a href="#data-sheets" data-toggle="tab" class="product-tab-link">{l s='Data sheet'}</a></li>
		 <li><a href="#info" data-toggle="tab" class="product-tab-link">{l s='More Info'}</a></li>
		 <li><a href="#prod-reviews" data-toggle="tab" class="product-tab-link">{l s='Reviews'}</a></li>
		</ul>
		<div class="info-wrapper">
			<!-- Data sheet -->
			<section class="page-product-box tab-pane active" id="data-sheets">
