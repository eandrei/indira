...
function display(view)
{
	if (view == 'list')
	{
		...
		$('.product_list > li').removeClass('col-xs-12 col-sm-6 col-md-4').addClass('col-xs-12 col-md-12');
...
$(document).ready(function() {
 /* $('#social_block').addClass('wow slideInUp'); 
  $('#newsletter_block_left').addClass('wow slideInUp'); */
  	$('.homeslider-description h4').addClass('wow fadeInUp');
	$('.homeslider-description h2').addClass('wow fadeInUp');
	$('.homeslider-description p').addClass('wow fadeInUp');
	$('.homeslider-description h4').css('-webkit-animation-delay', '0.05s');
	$('.homeslider-description h2').css('-webkit-animation-delay', '0.1s');
	$('.homeslider-description p').css('-webkit-animation-delay', '0.25s');
