...
<table id="summary-tab" width="100%">
    <tr>
        ...
        <th class="header small" valign="middle">{l s='Storno Factura' pdf='true'}</th>
    ...
    <tr>
        ...
        <td class="center small white">{dateFormat date=$order_slip->date_add full=0}</td>
        <td class="center small white">{$original_invoice_number}</td>
